...
function calcWidth(m) {
    var i = [];
    var l = m.getElementsByClassName("slide_module");
    for (var o = 0; o < l.length; o++) {
        i[o] = l[o].clientWidth * 1.06;
    }
    var n = 5;
...
function moveBalloon(w) {
    var r = w.parentElement.getElementsByClassName("slide_module")[0];
    ...
    for (var x = 0; x < u.length; x++) {
        ...
        if (z < 0) {
            if (global[B + "_ti"] != x) {
                ...
                //r.innerHTML = q.getElementsByClassName("slide_module")[0].innerHTML;
