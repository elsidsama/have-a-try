    ...
    $.fn.circliful = function (options) {
        ...
        return this.each(function () {
            ...
            if ($(this).data('text') != undefined) {
                ...
                if ($(this).data('type') != undefined) {
                    ...
                    if (type == 'half') {
                        ...
                        $(this).append('<p class="circle-text">' + icon + text + '</p>');
            ...
            if ($(this).data('info') != undefined) {
                ...
                if ($(this).data('type') != undefined) {
                    ...
                    if (type == 'half') {
                        ...
                        $(this).append('<p class="circle-info">' + info + '</p>');
            ...
            function animate(current) {
                ...
                //    context.height = y * window.devicePixelRatio;
                //    context.width = x * window.devicePixelRatio;
